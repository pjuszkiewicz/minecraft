...
void Renderer::update_shader(Player *player) {
    shader->use();
...
void Renderer::draw_new_chunks(const std::unordered_map<std::pair<int, int>, Chunk, PairHash> &chunks,
                               Player *player) const {
...
void Renderer::draw_chunk(const std::unordered_map<std::pair<int, int>, Chunk, PairHash> &chunks,
